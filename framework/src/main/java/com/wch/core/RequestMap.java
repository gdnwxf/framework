...
public class RequestMap extends HashMap<String, Object> implements Serializable {
    ...
    public String getSessionId() {
        return this.getStringValue(SESSION_ID);
    }
    ...
    public String getSystemType() {
        return getVersion().substring(0, 1);
    }
    ...
    public String getAppKey() {
        return this.getStringValue(APP_KEY);
    }
    ...
    public String getTimestamp() {
        return this.getStringValue(TIMESTAMP);
    }
    ...
    public String getSign() {
        return this.getStringValue(SIGN);
    }
    ...
    public Byte getBtyeValue(String key) {
        Object value = this.get(key);
        if (value != null) {
           ...
           return (Byte) convert(value, Byte.class);
        }
