...
//		this.context.getPlugins().initialized(this);
	...
	/*	JavaClientGeneratorConfiguration config = this.context.getJavaClientGeneratorConfiguration();
		if (config == null) {
			...
			sb.append(this.fullyQualifiedTable.getSubPackage(this.isSubPackagesEnabled(config)));
			return sb.toString();
		}*/
		return null;
	}
	...
	protected String calculateSqlMapPackage() {
		StringBuilder sb = new StringBuilder();
		SqlMapGeneratorConfiguration config = null;// this.context.getSqlMapGeneratorConfiguration();
		if (config != null) {
			sb.append(config.getTargetPackage());
			sb.append(this.fullyQualifiedTable.getSubPackage(this.isSubPackagesEnabled(config)));
		}
