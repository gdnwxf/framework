...
public class AnnotatedSelectByPrimaryKeyMethodGenerator extends SelectByPrimaryKeyMethodGenerator
{
  ...
  public void addMapperAnnotations(Interface interfaze, Method method)
  {
    ...
    if (this.useResultMapIfAvailable) {
      ...
      else addAnnotatedResults(interfaze, method);
    }
    else
  ...
  private void addResultMapAnnotation(Interface interfaze, Method method)
  {
    ...
    String annotation = String.format("@ResultMap(\"%s\")", new Object[] { (this.introspectedTable.getRules().generateResultMapWithBLOBs()) ? this.introspectedTable.getResultMapWithBLOBsId() : this.introspectedTable.getBaseResultMapId() });
