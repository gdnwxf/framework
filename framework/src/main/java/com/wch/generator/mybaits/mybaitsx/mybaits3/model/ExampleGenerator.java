...
public class ExampleGenerator extends AbstractJavaGenerator
{
  ...
  private String addtypeHandledObjectsAndMethods(IntrospectedColumn introspectedColumn, Method constructor, InnerClass innerClass)
  {
    ...
    method.addBodyLine(String.format("%s.add(new Criterion(condition, value, \"%s\"));", new Object[] { field.getName(), introspectedColumn.getTypeHandler() }));
    ...
    method.addBodyLine(String.format("%s.add(new Criterion(condition, value1, value2, \"%s\"));", new Object[] { field.getName(), introspectedColumn.getTypeHandler() }));
