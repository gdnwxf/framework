...
public class JdbcTypeNameTranslator {
	private static Map<Integer, String> typeToName = new TreeMap<Integer, String>();
	private static Map<String, Integer> nameToType = new TreeMap<String, Integer>();;
	...
	static {
		...
		typeToName.put(Integer.valueOf(-16), "LONGNVARCHAR");
		...
		nameToType.put("LONGNVARCHAR", Integer.valueOf(-16));
