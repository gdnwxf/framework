...
public class ProviderApplyWhereMethodGenerator extends AbstractJavaProviderMethodGenerator
{
  ...
  public void addClassElements(TopLevelClass topLevelClass)
  {
    ...
    importedTypes.add(new FullyQualifiedJavaType(String.format("%s.Criteria", new Object[] { fqjt.getFullyQualifiedName() })));

    importedTypes.add(new FullyQualifiedJavaType(String.format("%s.Criterion", new Object[] { fqjt.getFullyQualifiedName() })));
