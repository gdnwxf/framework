...
public class UpdateByPrimaryKeyWithBLOBsMethodGenerator extends AbstractJavaMapperMethodGenerator
{
  public void addInterfaceElements(Interface interfaze)
  {
    ...
    method.setName(this.introspectedTable.getUpdateByPrimaryKeyWithBLOBsStatementId());
    ...
    if (!(this.context.getPlugins().clientUpdateByPrimaryKeyWithBLOBsMethodGenerated(method, interfaze, this.introspectedTable))) {
      return;
    }
